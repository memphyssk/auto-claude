...
**Before accepting greenfield artifacts** ("build N new components"), grep for each named artifact. If 4-5 of 6 already exist, reclassify as "refactor existing + add N" and cite file paths. Greenfield framing hides pre-existing support, driving duplication.
